...
//         middle: Text("Monthly Ledger Summary"),
//       ),
//       child: SafeArea(
//         child: ListView(
...
//                   child: Text("Error: $e"),
//                 ),
//                 data: (MonthlyCashSummary m) => _monthCard(m),
//               );
//             }),
//           ],
//         ),
...
//   // ------------------------------
//   // Totals of all months
//   // ------------------------------
//   Widget _totalsSummary(List<AsyncValue<MonthlyCashSummary>> summaries) {
...
//         children: [
//           const Text(
//             "Total Summary (All Months)",
//             style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600),
//           ),
//           const SizedBox(height: 12),
//           _row("Total Receipts", totalReceipts),
//           _row("Total Expenses", totalExpenses),
//         ],
//       ),
//     );
//   }

//   Widget _monthCard(MonthlyCashSummary m) {
...
//           CupertinoPageRoute(
//             builder: (_) =>
//                 MonthlyReportScreen(date: DateTime.parse("${m.monthKey}-01")),
//           ),
//         );
//       },
//       child: Padding(
...
//                 DateFormat(
//                   'MMMM yyyy',
//                 ).format(DateTime.parse("${m.monthKey}-01")),
...
//               _row("Closing Balance", m.closingBalance),
//             ],
//           ),
//         ),
//       ),
